...
/// # Parameters
///
/// * `fills` - List of fill snapshots in chronological order
///
/// # Returns
///
...
/// # Parameters
///
/// * `simulated_qty` - The simulated position quantity
/// * `simulated_value` - The simulated position value
/// * `venue_qty` - The venue position quantity
/// * `venue_avg_px` - The venue position average price
/// * `tolerance` - The relative price tolerance (default 0.0001 = 0.01%)
///
/// # Returns
///
...
pub fn check_position_match(
    ...
    let simulated_avg_px = simulated_value / simulated_qty.abs();
...
/// # Parameters
///
/// * `fills` - All fills for the instrument in chronological order
/// * `venue_position` - The current position reported by the venue
/// * `instrument` - The instrument for price calculations
/// * `tolerance` - Price matching tolerance (default 0.0001 = 0.01%)
///
/// # Returns
///
